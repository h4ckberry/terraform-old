...
#    co1node1 - Edge(penwidth="1.0") - co2node3
    ...
    with Cluster("dir3graph", graph_attr=dir2graph_attr):
            dir3node1 = Node(style="filled", label="Dir2")
            dir3node2 = Node(style="invis", label="Dir2")
            dir3node3 = Node(style="filled", label="Dir2")
            (
                dir3node1 >>
                dir3node2 >>
                dir3node3
    ...
    dir2node1 - Edge(constraint="False",penwidth="2.0") - dir3node1
    dir2node2 - Edge(constraint="False",penwidth="2.0") - dir3node2
    dir2node3 - Edge(constraint="False",penwidth="2.0") - dir3node3
diag
